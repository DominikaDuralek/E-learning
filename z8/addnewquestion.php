...
//dodanie pytania do bazy	
		...
		$query = mysqli_query($link, "INSERT INTO question (idt, text, answer_a, answer_b, answer_c, answer_d, correct, file_name, file_extension) 
		VALUES ('$idt', '$text', '$answer_a', '$answer_b', '$answer_c', '$answer_d', '$correct', '$file_target_location', '$file_extension')");
