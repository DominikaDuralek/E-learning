	...
	<div class="content">
		...
		<div class="maincontent">	
			<?php
				...
				$idlquery = mysqli_query($link, "SELECT * FROM lesson WHERE name='$lessonname'");
				foreach ($idlquery as $row) {
					$idl = $row['idl'];
				}
				
				echo "Edycja lekcji: " . $lessonname . "<br><br>" ;
				
				echo "<form method='post' action='editlessonscript.php?idl=$idl' enctype='multipart/form-data'>
